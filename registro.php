...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($type == 'cachorro') {
        $fotocompleta=$photoName . "." . $extension;
        $stmt = $conn->prepare("INSERT INTO cachorros (sexo, porte, pelagem, foto, nome, idade, descricao) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssss", $gender, $size, $coat, $fotocompleta, $name, $age, $descricao);
    } else {
        $stmt = $conn->prepare("INSERT INTO gatos (sexo, porte, pelagem, foto, nome, idade, descricao) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssss", $gender, $size, $coat, $fotocompleta, $name, $age, $descricao);
    }
