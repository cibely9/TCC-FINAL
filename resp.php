...
<nav class="navbar">
    ...
    <div class="navbar-right">
        ...
        <a href="sobre.php" class="social-icon">
...
.navbar {
    ...
    align-items: center;
    background-color: #A9A9A9; /* Cor de fundo da navbar */
    padding: 12px 25px; /* Ajuste do padding para espaço interno */
    color: white;
    height: 75px;
